    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measure_type', models.CharField(choices=[('g', 'gramas'), ('ml', 'mililitros'), ('un', 'unidades'), ('kg', 'kilos')], max_length=2)),
